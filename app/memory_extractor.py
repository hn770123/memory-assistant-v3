...
The content values MUST be in the original language (Japanese) as spoken by the user.
...
{{
    ...
    "memories": [
        {{"content": "記憶内容", "category": "category_name"}}
    ],
    "goals": [
        {{"content": "目標内容", "priority": 5}}
    ],
    "requests": [
        {{"content": "お願い内容", "category": "category_name"}}
    ]
}}
```
...
*   Output **JSON ONLY**. No other text or explanations.
"""
